...
/**
 * Own copy of notification-service's policy (30s base, doubling, 8min cap, +/-20% jitter,
 * 5 attempts) rather than a shared module — the two are free to diverge per channel.
 *
 * Exponential backoff with jitter: delay doubles per attempt, capped at MAX_DELAY, with up
 * to +/-20% jitter so many deliveries failing at once don't all retry in lockstep.
 */
@Component
